// Anthropic Status Edge Function
// Returns the current Anthropic connection status for the authenticated user
...
serve(async (req) => {
  ...
  try {
    ...
    // Check for existing Anthropic integration
    ...
    console.error('Error in anthropic-status:', error)
