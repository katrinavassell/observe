...
const blindSpots = [
  {
    ...
    description:
      "You're allocating costs proportionally by revenue, not actual usage",
    icon: DollarSign,
  },
  {
    title: "Which features drive costs",
    description:
      "Some features may be 10x more expensive than others per request",
    icon: Lightbulb,
  },
  {
    title: "Optimal pricing response",
    description:
      "Should you raise prices, add usage limits, or optimize features?",
    icon: TrendingDown,
  },
];
...
<template>
  <Card
    class="border-amber-300 dark:border-amber-700 bg-amber-50/50 dark:bg-amber-950/20"
  >
      ...
      <div class="flex flex-col lg:flex-row gap-6">
        ...
        <div class="flex-1">
          <div class="flex items-start gap-4">
            <!-- Icon -->
            <div
              class="p-2.5 bg-amber-100 dark:bg-amber-900/50 rounded-lg shrink-0"
            >
            ...
            <div class="flex-1 space-y-4">
              ...
              <div>
                <h3
                  class="font-semibold text-amber-900 dark:text-amber-100 text-lg"
                >
                  What you can't see
                </h3>
                <p class="text-sm text-amber-700 dark:text-amber-300 mt-1">
                  These margins are estimates. Without feature-level cost
              ...
              <ul class="space-y-3">
                ...
                >
                  <div
                    class="w-6 h-6 rounded-full bg-amber-200 dark:bg-amber-800 flex items-center justify-center shrink-0"
                  >
                    <component
                      :is="spot.icon"
                      class="h-3.5 w-3.5 text-amber-700 dark:text-amber-300"
                    />
                  </div>
                  <div>
                    <p
        ...
        <div v-if="potentialSavings" class="lg:w-64 shrink-0">
          <div
            class="p-4 bg-green-50 dark:bg-green-950/30 rounded-lg border border-green-200 dark:border-green-800"
          >
            <div class="flex items-center gap-2 mb-2">
              ...
              <Tooltip>
                <TooltipTrigger>
                  <Badge
                    variant="secondary"
                    class="text-[9px] bg-green-100 dark:bg-green-900/50 text-green-700 dark:text-green-300"
                  >
                    Est.
                  </Badge>
                </TooltipTrigger>
            ...
            <p class="text-2xl font-bold text-green-700 dark:text-green-300">
              {{ formatCurrency(potentialSavings.low) }} -
              {{ formatCurrency(potentialSavings.high) }}
            </p>
      ...
      <div class="mt-6 pt-4 border-t border-amber-200 dark:border-amber-800">
        <div class="flex flex-wrap items-center justify-between gap-4">
          <p class="text-xs text-amber-600 dark:text-amber-400">
            Observe tracks cost-to-serve at the feature level, giving you the
            data to make informed pricing decisions.
          </p>
