...
import { Cpu, Upload, Download, CheckCircle, X } from "lucide-vue-next";
import {
  Card,
  CardContent,
  CardHeader,
...
onMounted(async () => {
  try {
    const { getOpenAIStatus, getAnthropicStatus } =
  ...
  <section>
    <Card>
      <CardHeader class="pb-3">
        ...
        <CardDescription
          >Connect AI providers or upload cost CSVs</CardDescription
        >
      </CardHeader>
