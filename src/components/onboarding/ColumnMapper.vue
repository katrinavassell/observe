...
import type { ColumnValidation } from "@/lib/api";
...
const fieldDefinitions: Record<string, FieldDefinition[]> = {
  accounts: [
    ...
    },
    {
      ...
      label: "Domain",
      required: false,
      description: "Company website (for matching)",
    },
    {
      key: "email",
      label: "Email",
    ...
    },
    {
      ...
      label: "Segment",
      required: false,
      description: "e.g., SMB, Mid-Market, Enterprise",
    },
    {
      key: "industry",
      label: "Industry",
  ...
  subscriptions: [
    ...
    },
    {
      ...
      label: "Customer ID",
      required: true,
      description: "Links to account_id",
    },
    {
      key: "plan_name",
      label: "Plan Name",
    ...
    },
    {
      ...
      label: "Status",
      required: false,
      description: "active, canceled, past_due",
    },
    {
      key: "start_date",
      label: "Start Date",
  ...
  invoices: [
    ...
    },
    {
      ...
      label: "Net Amount",
      required: false,
      description: "Amount after discounts",
    },
    {
      key: "currency",
      label: "Currency",
  ...
  usage: [
    ...
    },
    {
      ...
      label: "Metric Key",
      required: true,
      description: "e.g., api_calls, storage_gb",
    },
    {
      key: "metric_value",
      label: "Metric Value",
...
function getOptionsForField(fieldKey: string): string[] {
  ...
  const available = props.validation.detected_columns.filter(
    (col) => !used.has(col) || col === currentValue,
  );
  return ["", ...available];
}
  ...
  <div class="space-y-4">
    ...
    <div class="border rounded-lg overflow-hidden">
      <table class="w-full text-sm">
        ...
        <tbody>
          <tr v-for="field in fields" :key="field.key" class="border-t">
            <td class="py-2 px-3">
    ...
    >
      {{ validation.detected_columns.length - totalMappedCount }} columns in
      your file won't be imported
    </div>
    ...
    <div class="flex justify-between pt-2">
      ...
      <Button size="sm" :disabled="!allRequiredMapped" @click="handleConfirm">
