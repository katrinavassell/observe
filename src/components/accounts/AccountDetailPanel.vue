          ...
          <CardContent class="space-y-3">
            <div class="grid grid-cols-2 gap-3 text-sm">
              <div>
                ...
                <div>
                  <Badge v-if="account.segment" variant="outline">{{
                    account.segment
                  }}</Badge>
            ...
            <div
              v-if="account.website || account.email_domain"
              ...
              >
                <div>
                  ...
                  <div class="text-xs text-muted-foreground">
                    ...
                    <span v-if="sub.discount_percent">
                      · {{ sub.discount_percent }}% off</span
                    >
                  </div>
                </div>
                ...
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    <div class="font-medium text-sm">
                      {{ match.matched_account_name }}
                    </div>
                    <div class="text-xs text-muted-foreground capitalize">
                      {{ match.matched_source_system }}
                    </div>
                  </div>
                </div>
                <div class="text-right">
