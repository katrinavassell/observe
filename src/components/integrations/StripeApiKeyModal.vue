      ...
      <div class="w-full max-w-md rounded-lg border bg-card p-6 shadow-lg">
        ...
        <div class="space-y-4">
          ...
          <div class="text-sm text-muted-foreground">
            ...
            <a
              href="https://dashboard.stripe.com/apikeys/create?name=Tanso+Read+Only&permissions%5B%5D=rak_customer_read&permissions%5B%5D=rak_subscription_read&permissions%5B%5D=rak_product_read&permissions%5B%5D=rak_price_read"
              target="_blank"
