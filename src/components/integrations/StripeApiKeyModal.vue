...
async function handleSubmit() {
  ...
  if (!isKeyValid.value) {
    toast.error("Invalid API key format", {
      description:
        "Stripe keys should start with rk_live_, rk_test_, sk_live_, or sk_test_",
    });
    return;
  }
      ...
      <div class="w-full max-w-md rounded-lg border bg-card p-6 shadow-lg">
        ...
        <div class="flex items-center justify-between mb-4">
          <div class="flex items-center gap-2">
            <div
              class="h-8 w-8 rounded-lg bg-[#635bff] flex items-center justify-center"
            >
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-2">
            ...
            <p class="text-xs text-muted-foreground">
              Your key is encrypted and stored securely. We only read data,
              never write.
            </p>
          </div>
