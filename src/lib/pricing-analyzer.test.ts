...
const plans: Plan[] = [
  ...
  { plan_id: 'annual', name: 'Annual Pro', price_amount: 948, interval_months: 12 },
]
...
describe('calculateMRR', () => {
  ...
  it('calculates MRR from active subscriptions', () => {
    const subs: Subscription[] = [
      { subscription_id: 's1', customer_id: 'c1', plan_id: 'starter', is_active: true },
      { subscription_id: 's2', customer_id: 'c2', plan_id: 'pro', is_active: true },
    ]
  ...
  it('ignores inactive subscriptions', () => {
    const subs: Subscription[] = [
      { subscription_id: 's1', customer_id: 'c1', plan_id: 'starter', is_active: true },
      { subscription_id: 's2', customer_id: 'c2', plan_id: 'pro', is_active: false },
    ]
  ...
  it('uses mrr_override when provided', () => {
    const subs: Subscription[] = [
      { subscription_id: 's1', customer_id: 'c1', plan_id: 'pro', is_active: true, mrr_override: 150 },
    ]
  ...
  it('normalizes annual plans to monthly', () => {
    const subs: Subscription[] = [
      { subscription_id: 's1', customer_id: 'c1', plan_id: 'annual', is_active: true },
    ]
    // 948 / 12 = 79
  ...
  it('skips subscriptions with unknown plan_id', () => {
    const subs: Subscription[] = [
      { subscription_id: 's1', customer_id: 'c1', plan_id: 'nonexistent', is_active: true },
    ]
...
describe('calculatePlanHealth', () => {
  ...
  it('gives starter plans a lower health score', () => {
    const subs: Subscription[] = [
      { subscription_id: 's1', customer_id: 'c1', plan_id: 'starter', is_active: true },
      { subscription_id: 's2', customer_id: 'c2', plan_id: 'enterprise', is_active: true },
    ]
    const result = calculatePlanHealth(subs, plans, customers)
  ...
  it('detects negative margin customers', () => {
    ...
    const costs: CostRecord[] = [
      { customer_id: 'c1', cost_type: 'api', amount: 100, period_start: '2024-01-01' },
    ]
    const result = calculatePlanHealth(subs, plans, customers, undefined, costs)
    const starter = result.find(p => p.planId === 'starter')!
...
describe('analyzeUsageAnomalies', () => {
  ...
  it('detects upsell-ready customers near plan limit', () => {
    ...
    const usage: UsageRecord[] = [
      { customer_id: 'c1', metric_key: 'api_calls', metric_value: 950, metric_limit: 1000, period_start: '2024-03-01' },
    ]
  ...
  it('detects churn risk from declining usage', () => {
    const subs: Subscription[] = [
      { subscription_id: 's1', customer_id: 'c1', plan_id: 'pro', is_active: true },
    ]
    const usage: UsageRecord[] = [
      { customer_id: 'c1', metric_key: 'api_calls', metric_value: 1000, metric_limit: 5000, period_start: '2024-01-01' },
      { customer_id: 'c1', metric_key: 'api_calls', metric_value: 800, metric_limit: 5000, period_start: '2024-02-01' },
      { customer_id: 'c1', metric_key: 'api_calls', metric_value: 500, metric_limit: 5000, period_start: '2024-03-01' },
      { customer_id: 'c1', metric_key: 'api_calls', metric_value: 200, metric_limit: 5000, period_start: '2024-04-01' },
    ]
    const result = analyzeUsageAnomalies(usage, subs, plans, customers)
...
describe('analyzeNegativeMargins', () => {
  ...
  it('ignores customers with positive margins', () => {
    const subs: Subscription[] = [
      { subscription_id: 's1', customer_id: 'c1', plan_id: 'enterprise', is_active: true },
    ]
    const costs: CostRecord[] = [
...
describe('calculateCohorts', () => {
  ...
  it('groups customers by signup month', () => {
    const cohortCustomers: Customer[] = [
      { customer_id: 'c1', email: 'a@test.com', name: 'A', created_at: '2024-01-15' },
      { customer_id: 'c2', email: 'b@test.com', name: 'B', created_at: '2024-01-20' },
      { customer_id: 'c3', email: 'c@test.com', name: 'C', created_at: '2024-02-10' },
    ]
    const subs: Subscription[] = [
      { subscription_id: 's1', customer_id: 'c1', plan_id: 'pro', is_active: true },
      { subscription_id: 's2', customer_id: 'c2', plan_id: 'pro', is_active: true },
      { subscription_id: 's3', customer_id: 'c3', plan_id: 'starter', is_active: true },
    ]
  ...
  it('calculates retention rate correctly', () => {
    ...
    const subs: Subscription[] = [
      { subscription_id: 's1', customer_id: 'c1', plan_id: 'pro', is_active: true },
      { subscription_id: 's2', customer_id: 'c2', plan_id: 'pro', is_active: false, cancelled_at: '2024-03-01' },
    ]
    const result = calculateCohorts(cohortCustomers, subs, plans)
...
describe('analyzeData', () => {
  ...
  it('includes cost and margin data when costs are provided', () => {
    const data: AnalyzerData = {
      ...
      costs: [
        { customer_id: 'c1', cost_type: 'infrastructure', amount: 30, period_start: '2024-01-01' },
      ],
    }
